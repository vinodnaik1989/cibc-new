...
@Component({
  selector: 'app-home2f',
  templateUrl: './home2f.component.html',
  styleUrls: ['./home2f.component.scss']
})
export class Home2fComponent implements OnInit {
  ...
  constructor() { }
    ...
    ngOnInit() {
      ...
      new Canvas({
        ...
        // background: ['222, 99, 139', '222, 99, 139']
        // background: ['222, 99, 139', '34, 34, 34']
      });
    }
